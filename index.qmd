...
Ce support ne se substitue pas [aux formations R dispensées par les formateurs du MASA](https://ssm-agriculture.github.io/site-formations-R/). Il permet aux nouveaux agents ayant déjà pratiqué R dans un autre contexte de **découvrir les spécificités de Cerise et d'en faire un bon usage**.
