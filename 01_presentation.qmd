...
Cerise est articulé autour de 3 VM accessibles via votre navigateur et les URL suivantes :  

- https://rstudio.agriculture.rie.gouv.fr/ : accès général à tous les agents du SSM  
- https://rstudio2.agriculture.rie.gouv.fr/ : accès réservé Demesis et traitements gourmands en ressources  
- https://rstudio3.agriculture.rie.gouv.fr/ : accès réservé aux opérations particulières (RA / RICA ...)  
