...
URL à faire figurer dans vos favoris : [https://rstudio.agriculture.rie.gouv.fr/](https://rstudio.agriculture.rie.gouv.fr/)
...
- [**Packages**]{.blue}
    ...
    - Une liste pré-établie de packages est préinstallée sur CERISE pour chacune des versions R_Base
...
L'accès à l'espace personnel de Cerise peut être difficile lorsque vous êtes "perdu" dans l'arborescence riche de Cerise. Voici ci-dessous comment faire pour y accéder rapidement.  


![](img/acces_espace_perso.png){fig-align="center"}  

Remarque : soyez économe dans l'utilisation de votre espace personnel. A ne réserver que pour des expérimentations. Pas de recopie de données... 
