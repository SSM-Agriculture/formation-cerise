...
## Gestion des sessions (1/3)

- Lorsque vous vous connectez à Cerise, vous allez arriver sur l'écran de gestion des sessions :   

![](img/home.png){fig-align="center"}

- Sur les premières lignes, vous trouverez vos sessions ouvertes.  
- Sur les dernières lignes, vous trouvez les différents projets que vous avez récemment utilisés. 

## Gestion des sessions (2/3)

Un 2ème affichage des sessions est possible en passant par les paramètres :  

![](img/home_settings.png){fig-align="center"}

## Gestion des sessions (3/3)
...
Il est important de veiller à limiter votre nombre de sessions actives (maximum 3).  

Timeout des sessions inactives : Fermeture automatique après 4 jours d’inactivité  
...
Contactez le support pour demander un profil étendu : assistance.si-stat.sg@agriculture.gouv.fr
:::
...
- Parquet  
    Requiert le package {arrow} ou {duckdb} en R.  
...
Pour certains cas métiers spécifiques et sous certaines contraintes (sécurité/performance/maintenabilité...), il est possible de déployer sur internet des applications web (R/Shiny) sur [shinyapps.io](https://shinyapps.io/) ou [Posit Connect Cloud](https://connect.posit.cloud/).    
